...
func (r *Reader) next() error {
    ...
    reader, err := r.disc.ReadAttachment(chunk.URL, start, chunk.Size-1)
    if err != nil {
        return err
    }
    r.reader = reader
