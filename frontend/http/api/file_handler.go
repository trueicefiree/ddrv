...
func GetFileHandler(db *sql.DB) fiber.Handler {
...
func CreateFileHandler(db *sql.DB, mgr *ddrv.Manager) fiber.Handler {
    return func(c *fiber.Ctx) error {
        dirId := c.Params("dirId")
...
func DownloadFileHandler(db *sql.DB, mgr *ddrv.Manager) fiber.Handler {
    return func(c *fiber.Ctx) error {
        id := c.Params("id")
...
func UpdateFileHandler(db *sql.DB) fiber.Handler {
    return func(c *fiber.Ctx) error {
        id := c.Params("id")
        dirId := c.Params("dirId")
...
func DelFileHandler(db *sql.DB) fiber.Handler {
    return func(c *fiber.Ctx) error {
        id := c.Params("id")
        dirId := c.Params("dirId")
